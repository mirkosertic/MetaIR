...
public class OpcodeDUP2X2Test {

    @Test
    public void test_DUP2X2_form4(final MetaIRTestHelper testHelper) throws IOException {
    ...
    @Test
    public void test_DUP2X2_form3(final MetaIRTestHelper testHelper) throws IOException {
        final ClassModel model = ClassModelFactory.createModelFrom(classBuilder -> classBuilder.withMethod("test", MethodTypeDesc.of(ConstantDescs.CD_void), AccessFlag.PUBLIC.mask(), methodBuilder -> methodBuilder.withCode(codeBuilder -> {
            codeBuilder.lconst_1();
    ...
    @Test
    public void test_DUP2X2_form2(final MetaIRTestHelper testHelper) throws IOException {
        final ClassModel model = ClassModelFactory.createModelFrom(classBuilder -> classBuilder.withMethod("test", MethodTypeDesc.of(ConstantDescs.CD_void), AccessFlag.PUBLIC.mask(), methodBuilder -> methodBuilder.withCode(codeBuilder -> {
            codeBuilder.iconst_1();
            codeBuilder.iconst_1();
            codeBuilder.lconst_1();
    ...
    @Test
    public void test_DUP2X2_form1(final MetaIRTestHelper testHelper) throws IOException {
        final ClassModel model = ClassModelFactory.createModelFrom(classBuilder -> classBuilder.withMethod("test", MethodTypeDesc.of(ConstantDescs.CD_void), AccessFlag.PUBLIC.mask(), methodBuilder -> methodBuilder.withCode(codeBuilder -> {
            codeBuilder.iconst_1();
            codeBuilder.iconst_1();
            codeBuilder.iconst_1();
