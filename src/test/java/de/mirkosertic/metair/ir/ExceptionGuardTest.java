...
public class ExceptionGuardTest {
    ...
    public void testUsage() {
        final ExceptionGuard guard = new ExceptionGuard("Guard0", List.of(new ExceptionGuard.Catches(0, List.of(IRType.MetaClass.of(ClassDesc.of(IllegalArgumentException.class.getName())))), new ExceptionGuard.Catches(1, Collections.emptyList())));
        ...
        assertThat(guard.getNamedNode("catch : 0 : IllegalArgumentException")).isInstanceOf(Catch.class).matches(t -> ((Catch) t).exceptionTypes.equals(List.of(IRType.MetaClass.of(IllegalArgumentException.class))));
        ...
        assertThat(guard.catchProjection(0).exceptionTypes).isEqualTo(List.of(IRType.MetaClass.of(IllegalArgumentException.class)));
