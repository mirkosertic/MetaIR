...
class DebugStructuredControlflowCodeGeneratorTest {
    ...
    public void test_evaluate_add_PrimitiveInteger() {
        ...
        generator.emit(new Add(IRType.CD_int, new PrimitiveInt(10), new PrimitiveInt(20)));
        final String result = generator.toString();
        System.out.println(result);
    ...
    public void test_evaluate_add_PrimitiveInteger_nested() {
        ...
        generator.emit(new Add(IRType.CD_int, new PrimitiveInt(10), new Add(IRType.CD_int, new PrimitiveInt(20), new PrimitiveInt(30))));
        final String result = generator.toString();
        System.out.println(result);
    ...
    public void test_evaluate_add_PrimitiveInteger_nested2() {
        ...
        final Add nestedAdd = new Add(IRType.CD_int, new PrimitiveInt(10), new PrimitiveInt(20));
        generator.emit(new Add(IRType.CD_int, nestedAdd, nestedAdd));
        final String result = generator.toString();
        System.out.println(result);
