...
| [Sequencer & Code Generation](doc/SEQUENCER.md) | How the graph is re-linearised into structured output code — dominator-guided sequencing, the block stack, break/continue resolution, and the backend interface for new targets.                      |
